...
if __name__ == "__main__":
    ...
    kyobo_it_new_product_url = "http://www.kyobobook.co.kr/categoryRenewal/categoryTab.laf?perPage=2000&mallGb=KOR&linkClass=3315&menuCode=003&link6flag="

    soup_kyobo = parsing_kyobo_beautifulsoup(
        kyobo_it_new_product_url)
